...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("/templates/twsy");
	templateBuilder.Append("/images/3.gif\" alt=\"\" />\r\n                <div class=\"location\"><span>location:Home&gt;Show Case&gt;show</span></div>\r\n            </div>\r\n            <div class=\"photo_list\">\r\n                  <span style=\"display: block;margin-left: 20px;color: red;margin-top: 10px;text-align: center;font-size: 18px;\">Hot product</span>\r\n                 <ul style=\"list-style: none;\">\r\n                         ");
	DataTable photo_list = get_article_list("productEn", 0, 12, "is_red=1");

	foreach(DataRow dr in photo_list.Rows)
	{

	templateBuilder.Append("\r\n                         <li style=\"height: 200px;width: 160px;word-wrap:break-word !important;overflow:hidden; text-overflow:clip;white-space:normal\">\r\n                             <a style=\"height: 200px;width: 160px;display: block;margin-left:0px\"  class=\"img\" href=\"");
	templateBuilder.Append(linkurl("product_showEn",Utils.ObjectToStr(dr["id"])));

	templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">\r\n                                 <img  src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\" style=\"margin:0;float:none\" />\r\n                                 <p style=\"display: block;height: 40px;width: 160px;text-align: center;margin-right:0;float: none;word-wrap: break-word !important;\">" + Utils.ObjectToStr(dr["title"]) + "wwee rrree  </p>\r\n                               \r\n                             </a>                         \r\n                         </li>\r\n\r\n                         ");
	}	//end for if

	templateBuilder.Append("\r\n                    \r\n                     </ul>\r\n                    \r\n                   <p style=\"display: block;height: 40px;width: 160px;text-align: center;margin-right:0;float: none;word-wrap: break-word !important;\">wwwwwwwwww wwwwwweeeeeeeeeeee wwee rrree  </p>\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n    <div class=\"clear\"></div>\r\n    ");
