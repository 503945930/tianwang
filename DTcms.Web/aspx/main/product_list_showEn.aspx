...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("/templates/twsy");
	templateBuilder.Append("/images/3.gif\" alt=\"\" />\r\n                <div class=\"location\"><span>location:Home&gt;Products&gt;Show</span></div>\r\n            </div>\r\n            <div class=\"photo_list\">\r\n                <span style=\"display: block;margin-left: 20px;color: red;margin-top: 10px;text-align: center;font-size: 18px;\">");
	templateBuilder.Append(Utils.ObjectToStr(category_title));
	templateBuilder.Append("</span>\r\n                \r\n                   <ul style=\"list-style: none;\">\r\n                           ");
	DataTable photo_list = get_article_list("productEn", category_id, page, "status=0", out totalcount, out pagelist, "product_list_showEn", category_id, "__id__");
	...
	templateBuilder.Append("\" title=\"" + Utils.ObjectToStr(dr["title"]) + "\">\r\n                                 <img  src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\" style=\"margin:0;float:none\" />\r\n                                 <p style=\"display: block;height: 40px;width: 160px;text-align: center;margin-right:0;float: none;word-wrap: break-word !important;\">" + Utils.ObjectToStr(dr["title"]) + "weeeeeeeeeee </p>\r\n                               \r\n                             </a>                         \r\n                         </li>\r\n\r\n                         ");
	}	//end for if
